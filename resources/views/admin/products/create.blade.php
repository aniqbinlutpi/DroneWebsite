            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-400 mt-2">Add a new drone product to your inventory</p>
                    </div>
            ...
            <div class="bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-gray-500 transition-colors">
                                ...
                                <div class="text-gray-400">
                                    ...
                                    <p class="text-sm">Click to upload featured image</p>
                        ...
                        <!-- Additional Images -->
                        <div>
                            <label for="images" class="block text-sm font-medium text-gray-300 mb-2">Additional Images</label>
                            <div class="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-gray-500 transition-colors">
                                <input type="file" 
                                       id="images" 
                                       name="images[]" 
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="specifications" 
                                      ...
                                      rows="4"
                                      class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Technical specifications (one per line)">{{ old('specifications') }}</textarea>
